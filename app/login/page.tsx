...
export default function LoginPage() {
  ...
  const { signIn, testSignIn, user, role } = useAuth()
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 px-4 py-12 relative overflow-hidden">
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8">
          ...
          <div className="mt-6 pt-6 border-t border-white/10">
            <Link
              href="/"
              className="block text-center text-sm text-gray-300 hover:text-white transition-colors flex items-center justify-center gap-2"
            >
