...
export const APPOINTMENT_DETAIL_SELECT =
  'id, appointment_date, appointment_time, onsite_type, patient_id, service_id, location_id, services:service_id ( id, title_en, title_es ), locations:location_id ( title, location_code, tenant_id )'
